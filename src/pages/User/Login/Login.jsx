...
const Login = () => {
  ...
  return (
    <div className=" bg-gray-900 md:py-10 px-3 md:px-5 max-w-7xl mx-auto">
      {state?.successRegister && (
        <div className="bg-green-800 text-gray-200 p-4 rounded-lg mb-4 shadow-lg flex items-center">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-center bg-gray-800 border border-gray-700 rounded-lg shadow-lg  gap-6">
            ...
            <div className="w-full relative mt-5 rounded-lg overflow-hidden">
              ...
              <div className="absolute inset-0 bg-black bg-opacity-50 flex justify-center items-center rounded-2xl">
                <div className="flex items-center justify-center text-white p-5 rounded-lg overflow-hidden">
                  <h3 className="text-lg whitespace-nowrap text-center font-semibold w-1/3">
                    About us
                  </h3>
                  <p className="w-2/3" style={{ textAlign: "justify" }}>
                    ...
                    <span className="text-gray-400">
                      tech enthusiasts, alumni, and students
                    </span>{" "}
                    connect and collaborate to innovate and inspire.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="w-full bg-gray-700 shadow-lg rounded-lg h-full flex flex-col justify-center items-center px-10 py-14">
            ...
            <form onSubmit={handleSubmit} className="space-y-8 w-full">
              ...
              {isLoading ? (
                <button
                  disabled
                  className="flex items-center justify-center w-full bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded-lg transition-colors"
                >
                  <IoReload className="animate-spin h-6 w-6 " />
                </button>
              ) : (
                <button
                  type="submit"
