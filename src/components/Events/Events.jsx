      ...
      <div className="max-w-7xl mx-auto px-4 space-y-6">
        ...
        <div className="grid grid-cols-1 gap-6 py-10">
          {eventData.map((item, index) => (
            <div key={index} className="bg-white overflow-hidden grid lg:grid-cols-3">
              {/* Event Info */}
              <div className="p-6">
              ...
              <div className="bg-gray-50 p-6 flex flex-col justify-center items-center">
                <p className="text-lg font-semibold text-[#C3E92D] mb-1 text-start">Ticket</p>
                <div className="flex items-start">
                  <p className="text-5xl font-extrabold text-gray-900">{item.ticketPrice}</p>
                  <span className="text-sm text-gray-500 ml-1 self-end">/ticket</span>
                </div>
